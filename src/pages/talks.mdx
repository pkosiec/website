import Metadata from '@site/src/components/talks/Metadata';

# Talks

## Building GraphQL API for Kubernetes resources

<Metadata eventName="Cloud Native Warsaw" location="Warsaw, Poland" date="10.2019"/>
...
<Metadata eventName="SAP Labs Hack Your Career" location="Gliwice, Poland" date="03.2019"/>
...
<Metadata eventName="Gophers Silesia" location="Katowice, Poland" date="05.2018"/>
